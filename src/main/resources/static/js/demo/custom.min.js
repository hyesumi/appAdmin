...
/* 추가JS */
	var CURRENT_TITLE = $('.page-title .title_left .cur_title').text().replace(' ',''); 
	$SIDEBAR_MENU.find('a').filter(function () {
		var THIS_MENU = this.text.replace(' ','');
		return THIS_MENU == CURRENT_TITLE;
...
$('.info_change_group').find('.info_change_input').hide();
	$('.info_change_group').find('button').on('click',function(){ 
		if($(this).hasClass('info_change')){
			$(this).hide().next('.info_change_input').show();
		}
		if($(this).hasClass('info_cancel')){
			$(this).parent('.info_change_input').hide().find('.form-control').val('');
			$(this).parent('.info_change_input').siblings('.info_change').show();
		}
	});
	...
	$('.draggable_item').bind('drop', function(event) {
		return false;
	});
